...
export function AdminSidebar({ onNavigate }: AdminSidebarProps) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-maroon text-ivory">
      <div className="shrink-0 border-b border-ivory/10 px-6 py-6">
      ...
      <div className="shrink-0 border-t border-ivory/10 p-3">
